...
/** Create class */
ezobjects.createClass(configRadioGroup);

/** Add group class helper */
RadioGroup.prototype.addGroupClass = function (groupClass) {
...
RadioGroup.prototype.addGroupLabelClass = function (groupLabelClass) {
  /** Get array of non-empty class names to be added */
...
RadioGroup.prototype.addInputClass = function (inputClass) {
  /** Get array of non-empty class names to be added */
...
RadioGroup.prototype.addInputLabelClass = function (inputLabelClass) {
  /** Get array of non-empty class names to be added */
...
RadioGroup.prototype.addInputWrapperClass = function (inputWrapperClass) {
  /** Get array of non-empty class names to be added */
...
RadioGroup.prototype.addWrapperClass = function (wrapperClass) {
  /** Get array of non-empty class names to be added */
...
RadioGroup.prototype.removeGroupClass = function (groupClass) {
...
RadioGroup.prototype.removeGroupLabelClass = function (groupLabelClass) {
  /** Get array of non-empty class names to be removed */
  const classes = groupLabelClass.trim().split(` `).map(x => x.trim()).filter(x => x.length > 0);
...
RadioGroup.prototype.removeInputClass = function (inputClass) {
  /** Get array of non-empty class names to be removed */
  const classes = inputClass.trim().split(` `).map(x => x.trim()).filter(x => x.length > 0);
...
RadioGroup.prototype.removeInputLabelClass = function (inputLabelClass) {
  /** Get array of non-empty class names to be removed */
  const classes = inputLabelClass.trim().split(` `).map(x => x.trim()).filter(x => x.length > 0);
...
RadioGroup.prototype.removeInputWrapperClass = function (inputWrapperClass) {
  /** Get array of non-empty class names to be removed */
  const classes = inputWrapperClass.trim().split(` `).map(x => x.trim()).filter(x => x.length > 0);
...
RadioGroup.prototype.removeWrapperClass = function (wrapperClass) {
  /** Get array of non-empty class names to be removed */
  const classes = wrapperClass.trim().split(` `).map(x => x.trim()).filter(x => x.length > 0);
...
RadioGroup.prototype.render = function (indent = 0) {
  /** Validate width */
